...
model = dict(
    ...
    extractor=dict(
        ...
        input_size=(112, 112),
        num_layers=50,
        pretrained='../../../input/backbone/backbone_ir50_ms1m_epoch120.pth',#''../../../input/backbone/backbone_ir50_ms1m_epoch120.pth
        mode='ir',
    ...
    vit=dict(
        type='PoolingViT',
        pretrained='../../../input/vit-small/vit_small_p16_224-15ec54c9.pth'',#../../../input/vit-small/vit_small_p16_224-15ec54c9.pth',
        input_type='feature',
        patch_num=196,
        in_channels=[256],
...
data = dict(
    samples_per_gpu=64,    # total batch size: 128
    workers_per_gpu=8,
)
