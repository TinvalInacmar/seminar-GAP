...
class IRSE(BaseBackbone):
    def __init__(self, input_size, num_layers, mode='ir', with_head=False, pretrained=None, multi_finetune=False, return_index=(0, 1, 2),
                return_type='Tuple'):
        super().__init__()
        ...
        if pretrained:
            self.init_weights(pretrained, multi_finetune)
 
    def init_weights(self, pretrained, multi_finetune):
